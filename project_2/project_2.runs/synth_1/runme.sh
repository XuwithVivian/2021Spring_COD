...
HD_PWD='C:/Users/86139/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_PDU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_PDU.tcl
