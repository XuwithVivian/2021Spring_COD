...
HD_PWD='C:/Users/86139/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_PDU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_PDU.tcl -notrace
